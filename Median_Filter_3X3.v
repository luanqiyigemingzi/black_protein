...
//分别对3x3矩阵的三行像素进行排序，输出每行的“最大值，中值，最小值”
//Step1
...
(
	...
	.max_data	(),
	.mid_data	(),
	.min_data   (max_min_data)	//3行最大值中的最小值
);
...
(
	...
	.max_data	(),
	.mid_data	(mid_mid_data),	//2行中值中的中值
	.min_data   ()
);
...
(
	...
	.max_data	(min_max_data),	//3行最小值中的最大值
	.mid_data	(),
	.min_data   ()
);
