module auto_created_cwc1 (  
    ...
    localparam CWC_BUS_DIN_NUM = 16;
	localparam CWC_CTRL_LEN = 76;
	localparam CWC_BUS_CTRL_LEN = 56;
    localparam RAM_LEN = 16;
    localparam INPUT_PIPE_NUM = 0;
    localparam OUTPUT_PIPE_NUM = 0;
    localparam RAM_DATA_DEPTH = 1024;
	localparam CWC_CAPTURE_CTRL_EXIST = 0;
    localparam integer CWC_BUS_WIDTH[0:1] = {8,8};
    localparam integer CWC_BUS_DIN_POS[0:1] = {0,8};    
    localparam integer CWC_BUS_CTRL_POS[0:1] = {0,28};    
